...
public static class GlobalAffixes
{
    public static ImmutableDictionary<EquippableSlot, ImmutableArray<AffixFamily>> Prefixes =
        new Dictionary<EquippableSlot, ImmutableArray<AffixFamily>>()
        {
            ...
            { EquippableSlot.Chest, [GreaterLife, Mana] },
            { EquippableSlot.Head, [GreaterLife, Mana] },
            { EquippableSlot.Gloves, [GreaterLife, Mana] },
            { EquippableSlot.Boots, [GreaterLife, Mana] },
            { EquippableSlot.Belt, [GreaterLife, Mana] },
    ...
    private static AffixFamily LesserLife = new(
        AffixId.LesserLife,
        [
    ...
    private static AffixFamily GreaterLife = new(
        AffixId.GreaterLife,
        [
    ...
    private static AffixFamily Mana = new(
        AffixId.Mana,
        [
    ...
    private static AffixFamily LifeOnKill = new(
        AffixId.LifeOnKill,
        [
    ...
    private static AffixFamily ManaOnKill = new(
        AffixId.ManaOnKill,
        [
    ...
    private static AffixFamily FireResistance = new AffixFamily(
    ...
    private static AffixFamily ColdResistance = new AffixFamily(
    ...
    private static AffixFamily LightningResistance = new AffixFamily(
    ...
    private static AffixFamily Strength = new AffixFamily(
        AffixId.Strength,
        [
    ...
    private static AffixFamily Agility = new AffixFamily(
        AffixId.Agility,
        [
    ...
    private static AffixFamily Intelligence = new AffixFamily(
    ...
    private static AffixFamily Vitality = new AffixFamily(
        AffixId.Vitality,
        [
    ...
    private static AffixFamily Spirit = new AffixFamily(
        AffixId.Spirit,
        [
